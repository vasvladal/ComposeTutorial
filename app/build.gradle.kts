...
dependencies {
    ...
    // Declared once here and reused below — don't add a second
    // implementation(platform(libs.androidx.compose.bom)) line further down.
    ...
    // Compose libraries (versions resolved by the BOM above)
